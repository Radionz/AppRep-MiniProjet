...
public class ClassFileServer extends ClassServer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println(classFileServer.getHostname());
            System.out.println(classFileServer.getServerSocketPort());
        } catch (java.io.IOException e) {
     ...
     * @return the bytecodes for the class
     * @throws java.io.IOException if the class cannot be read
     */
